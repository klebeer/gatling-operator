...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GatlingRunnerConfig) DeepCopyInto(out *GatlingRunnerConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GatlingRunnerConfig.
func (in *GatlingRunnerConfig) DeepCopy() *GatlingRunnerConfig {
	if in == nil {
		return nil
	}
	out := new(GatlingRunnerConfig)
	in.DeepCopyInto(out)
	return out
}
